...
use App\Filament\Resources\Wipsys\PartshistoryResource\Pages;
use App\Filament\Resources\Wipsys\PartshistoryResource\RelationManagers;
...
class PartshistoryResource extends Resource
{
    protected static ?string $model = Partshistory::class;
    ...
    {
        return [
            'index' => Pages\ListPartshistories::route('/'),
            'create' => Pages\CreatePartshistory::route('/create'),
            'edit' => Pages\EditPartshistory::route('/{record}/edit'),
        ];
    }    
}
